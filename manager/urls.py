...
urlpatterns=[
    ...
    path('order/summary/search/item/',views.searchOrder,name='search orderitem'),
    path('home/summary/search/item/',views.searchOrderHome,name='search orderitem home'),
    path('view/order/logs/<int:id>/',views.OrderLogger,name='order logs'),
    path('new/user/',newUser.as_view(),name='new user'),
    path('insert/orders/',views.insertView,name='insert order'),
